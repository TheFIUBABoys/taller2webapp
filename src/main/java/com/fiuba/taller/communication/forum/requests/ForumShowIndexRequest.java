...
public class ForumShowIndexRequest {

	private String username;
	private Integer id_ambito;
	private Integer id_foro;
	
    public ForumShowIndexRequest(){}
	
    public ForumShowIndexRequest(String username, String section_name, Integer id_ambito, Integer id_foro)
    {
        super();
