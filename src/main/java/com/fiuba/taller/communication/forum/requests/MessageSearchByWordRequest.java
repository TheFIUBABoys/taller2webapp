...
public class MessageSearchByWordRequest {
    ...
    public MessageSearchByWordRequest(String username, String content, String section_name, Integer id_ambito, Integer id_mensaje, Integer id_foro, Integer id_tema)
    {
        super();
