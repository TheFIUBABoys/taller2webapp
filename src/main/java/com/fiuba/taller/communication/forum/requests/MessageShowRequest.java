...
public class MessageShowRequest {
    ...
    public MessageShowRequest(String username, String content, String section_name, Integer id_ambito, Integer id_mensaje, Integer id_foro, Integer id_tema)
    {
        super();
    ...
    public Form toForm(){
        ...
        dataAsForm.param("id_mensaje", Integer.toString(id_mensaje));
