...
public class SubForumEditRequest {
    ...
    public SubForumEditRequest(){}
	
    public SubForumEditRequest(String username, String section_name, Integer id_ambito, Integer id_foro)
    {
        super();
    ...
    public Map<String, String> toMap(){
        ...
        dataAsMap.put("subforum_name", subforum_name);
